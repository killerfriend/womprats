...
Brief description at a high level of the scope, approach, resources and schedule of the testing activities involved. Provide a concise summary of the test plan objectives, the products to be delivered, major work activities, major work products, major milestones, required resources, and master high-level schedules, budget, and effort requirements.)
...
Explain how the equipment will be intialized for field use (for replication purposes)
...
\textbf{Outputs}& 3v3DC: Regulated 3.3 VDC Power.\\
	      & Status: LED to display if the input power is available.\\ 
\hline
\textbf{Functionality}& The power supply fuse circuitry is able to detect high current and safely prevent damage by burning the protection fuse.\\
\hline
\textbf{Test No.}& PS-UT-02\\
\hline
\end{tabular}
...
\textbf{Outputs}& 3v3DC: Regulated 3.3 VDC Power.\\
\hline
\textbf{Functionality}& Determine the voltage ripple generated from the power supply output.\\
\hline
\textbf{Test No.}& PS-UT-03\\
\hline
\end{tabular}
...
\textbf{Inputs}& 5VDC: Unregulated power from 5 VDC wall-wart power supply.\\
	     & Switch: On/Off Power Switch.\\
\hline
\textbf{Outputs}& Temperature: Heat created by the voltage regulator.\\
\hline
\textbf{Functionality}& Determine the temperature dissipated by the power supply.\\
\hline
\textbf{Test No.}& PS-UT-04\\
\hline
\end{tabular}
...
\textbf{Inputs} & Power: 3.3 VDC Power\\
	      ...
	      & Volume: Controls the audio output volume. Logarithmic control.\\
\hline
\textbf{Outputs}& Frequency: Frequency of the line out and speaker output.\\
\hline
\textbf{Functionality}& Determine the operating frequency range of the audio amplifier.\\
\hline
\textbf{Test No.}& Amp-UT-02\\
\hline
\end{tabular}
...
\textbf{Inputs} & Power: 3.3 VDC Power\\
	      & Audio: 0-3.3V audio signal from DAC\\
	      & Volume: Controls the audio output volume. Logarithmic control.\\
                 & Headphone Jack: Headphone is plugged into the headphone jack.\\
\hline
\textbf{Outputs}& Headphone: Audio signal outputs only to the headphone/line out and disables the speaker output.\\
\hline
\textbf{Functionality}& Verify the headphone detection circuitry works as designed.\\
\hline
\textbf{Test No.}& Amp-UT-03\\
\hline
\end{tabular}
...
\textbf{Inputs} & Power: 3.3 VDC Power\\
	      ...
	      & Volume: Controls the audio output volume. Logarithmic control.\\
\hline
\textbf{Outputs}& Volume: Loudness.\\
\hline
\textbf{Functionality}& Verify the volume control works.\\
\hline
\textbf{Test No.}& Amp-UT-04\\
\hline
\end{tabular}
...
\textbf{Inputs} & Power: 3.3 VDC Power\\
	      ...
	      & Volume: Controls the audio output volume. Logarithmic control.\\
\hline
\textbf{Outputs}& Temperature: Heat created by the audio amplifier IC.\\
\hline
\textbf{Functionality}& Determine the temperature dissipated by the audio amplifier.\\
\hline
\textbf{Test No.}& Amp-UT-04\\
\hline
