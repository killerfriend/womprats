...
\end{center}
  Issue \#1: with LDO pins being incorrectly routed on the PCB\\
...
\begin{center}
 \includegraphics[width=0.7\textwidth]{pcb.png}
\end{center}
  Issue \#2: Powering on the microcontroller\\
...
\end{center}
  ...
  Solution: Shaved as much unnecessary header material to make it fit
}
