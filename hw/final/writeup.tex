...
\frame{{Objective}
  ...
  \pause 
  Make Dead Week in the Capstone Lab as annoying as possible.

  \pause
  Demonstrate our ``Phat Engineering Skillz''

  \pause
  Develop an extensible music platform.

  \pause Develop a project that is easy to demonstrate in an interview situation. 
}
